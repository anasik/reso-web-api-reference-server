...
public class RESOservlet extends HttpServlet {
    ...
    private static Map<String, Map<String, ResourceInfo>> tenantResourceLookup = new HashMap<>();
     ...
     */
    public static Map<String, ResourceInfo> getResourceLookupForTenant(String tenantId) {
